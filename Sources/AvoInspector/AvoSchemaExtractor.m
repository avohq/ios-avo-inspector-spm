...
-(AvoEventSchemaType *) objectToAvoSchemaType: (id) obj {
     @try {
        ...
        if ([paramType isEqual: @"__NSCFNumber"]) {
        ...
        } else if ([paramType isEqual: @"NSConstantIntegerNumber"]) {
            return [AvoInt new];
        } else if ([paramType isEqual: @"NSConstantDoubleNumber"] ||
                   [paramType isEqual: @"NSConstantFloatNumber"]) {
            return [AvoFloat new];
            ...
            return [AvoBoolean new];
                   ...
                   [paramType containsString: @"NSConstantArray"]) {
            ...
            return result;
                   ...
                   [paramType containsString: @"NSConstantDictionary"] ||
